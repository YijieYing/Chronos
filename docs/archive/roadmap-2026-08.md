# Chronos roadmap — archived migration design

Archived on 2026-09-05. This is the previous design/backlog, including historical progress notes;
it is not a statement of current capability. Relative links and paths below retain their original
context. See [current roadmap](../roadmap.md), [feature audit](../feature-audit-2026-09-05.md), and
[architecture](../architecture.md) for current decisions. Original content follows unchanged.
